@component('admin.component.content')
    ...
    @slot('addicon')
        {{-- <a href="{{route('admin.blog.add')}}"><button class="btn btn-sm btn-primary"><b>+</b></button></a> --}}
    @endslot
    ...
    @slot('content')
        <form class='row forms-sample w-full' name='formData' onsubmit='return false;' method='POST'>
            ...
            <div class='form-group col-12 mt-3'>
                ...
                <input type='text' name='metaDescription' class='form-control' placeholder="Enter Meta Description">
            </div>
            ...
            <div class='form-group col-12 mt-3'>
                ...
                <input type='text' name='shortTitle' class='form-control' placeholder="Enter Short Title">
            </div>
